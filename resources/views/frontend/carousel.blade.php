...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/user/mdb.min.css') }}">
    ...
    <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
                <div class="view" style="background-image: url('https://static.bongda24h.vn/medias/original/2020/7/24/Chelsea-chuan-bi-vung-tien-tan-don-sao-Atletico-Madrid-hinh-anh.jpeg'); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <p>
                            ...
                            <strong>Free for personal and commercial </strong>
                        </p>
                    ...
                    <div class="col-lg-6 col-md-12 px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                ...
                                <p class="grey-text">We care about the development of our users. We have prepared numerous tutorials, which allow you to learn how s other technologies.</p>
                            </div>
                        </div>
                        <!--/Third row-->
                ...
                <div class="row features-small mb-5 mt-3 wow fadeIn">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h6 class="feature-title">Free for personal and commercial </h6>
                                <p class="grey-text">Our license is user-friendly. Feel free to  private as well as commercial projects.
                                </p>
