...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/user/open-iconic-bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/user/ionicons.min.css') }}">

    <link rel="stylesheet" href="{{ asset('css/user/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('css/user/jquery.timepicker.css') }}">

    <link rel="stylesheet" href="{{ asset('css/user/mdb.css') }}">
...
<body>
        ...
        <span class="oi oi-menu"></span> Menu
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="{{ route('user.index') }}" class="nav-link">TRANG CHỦ</a></li>
                    <li class="nav-item"><a href="{{ route('user.about') }} " class="nav-link">VỀ FASTTRACK</a></li>
                    <li class="nav-item"><a href="{{ route('user.course') }}" class="nav-link">KHÓA HỌC</a></li>
                    <li class="nav-item"><a href="{{ route('user.teacher') }}" class="nav-link">BLOG</a></li>
                    <li class="nav-item"><a href="{{ route('user.blog') }}" class="nav-link">LIÊN HỆ</a></li>
                    <li class="nav-item"><a href="{{ route('user.event') }}" class="nav-link">ĐĂNG NHẬP</a></li>
                  </ul>
            </div>
        </div>
    </nav>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="hero__text">
                                        ...
                                        <p>3/8/2020</p>
                                        <a href="#" class="btn ">ĐĂNG KÝ NHẬN TƯ VẤN</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="hero-wrap" style="background-image:  url('{{ asset('image/user/banner2.png') }}'); background-attachment:fixed;">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-10 ftco-animate">
                    <p><strong>When she reached</strong> the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful
