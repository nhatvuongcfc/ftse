...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-xl fixed-top" id="mainNav">
        <div class="brand">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <img src="{{ asset('img/user/logo-text.png') }}" alt="" width="220px" >
            </a>
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu parent-menu" aria-labelledby="dropdownMenuLink1">
                        ...
                        <div class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle js-scroll-trigger" href="#" role="button" id="dropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-weight: 100; margin-left: 6%; color: black;">
                                    Khóa học ngắn hạn
                                </a>
    ...
    <div class="login">
        <div class="container-login100">
            <div class="wrap-login100" style='background-image:url("{{ asset('img/user/bg-login.png') }}");'>
                <form method="POST" action="" class="login100-form validate-form">
                    <span class="login100-form-logo">
                            <img class="logo-image sizefull" src="{{ asset('img/user/logo-img.png') }}" alt="">
                        </span>
              ...
              <div class="device">
                <div class="screen">
                   Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                        <!-- <img src="https://fasttrack.edu.vn/wp-content/uploads/2020/05/banner-2-2020.jpg.png" class="img-fluid" alt=""> -->
                        <!-- </div> -->
                        <!-- <div class="button"> -->
    ...
    <footer class="footer sticky-footer site-footer">
        <div class="row">
            <div class="col-md-4">
                ...
                <ul class="footer-links">
                    <li>
                        <a href=""><i class="fas fa-fw far fa-envelope"></i><span> Email:contact@fasttrack.edu.vn</span></a>
                    </li>
                    <li>
                        <a href=""><i class="fas fa-fw fa-phone"></i><span> Hotline: 0962.07.44.78</span></a>
                    </li>
                    <li>
                        <a href=""><i class="fas fa-fw fa-map-marker-alt"></i><span> 65 Chu Mạnh Trinh, Khuê Trung, Cẩm Lệ, Đà Nẵng</span></a>
                    </li>
                </ul>
            </div>
            <div class="col-md-4">
                ...
                <ul class="footer-links">
                    <li>
                        <a href=""><span>Lập trình viên chuyên nghiệp</span></a>
                    </li>
                    <li>
                        <a href=""><span>Lập trình Front End</span></a>
                    </li>
                    <li>
                        <a href=""><span>Lập trình Java</span></a>
                    </li>
                    <li>
                        <a href=""><span>Lập trình PHP</span></a>
                    </li>
                    <li>
                        <a href=""><span>Lập trình .NET</span></a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="copyright-text">&copy; <a href="#" class="copyright-text" style="font-weight: 600;">Fast Track SE 2020</a>.</p>
            </div>
