                                    ...
                                    @foreach ($categories as $key=> $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="delete" onclick="delete_one({{$category->id}})" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                            </td>
                                            <td>
                                                <div class="custom-control  custom-checkbox custom-control-inline">
                                                   <input type="checkbox" name="options[]" class=" checkbox_some custom-control-input" id="{{$category->id}}">
